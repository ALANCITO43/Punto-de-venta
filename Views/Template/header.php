            ...
            <div class="container-fluid d-flex align-items-center justify-content-between">
                <div class="navbar-header">
                    ...
                    <!-- Navbar Header--><a href="<?php echo base_url(); ?>Admin/Listar" class="navbar-brand">
                        <div class="brand-text brand-big visible"><strong class="text-primary">Tien- </strong><strong class="text-white">Lirios</strong></div>
                        <div class="brand-text brand-sm"><strong class="text-primary">T</strong><strong>L</strong></div>
                    </a>
                    <!-- Sidebar Toggle Btn-->
                    <button class="sidebar-toggle"><i class="fas fa-arrow-alt-circle-left"></i></button>
                </div>
                <div class="right-menu list-inline no-margin-bottom">
                    <h4>Sistema de Venta <strong class="text-primary">México, <?php echo date("d-M-Y") ?></strong></h4>
                </div>
                <!-- Log out               -->
                <div class="list-inline-item logout">
                    <button class="btn btn-primar.00" type="button" data-toggle="modal" data-target="#logout">Salir</button>
                </div>
            </div>
            </div>
        </nav>
